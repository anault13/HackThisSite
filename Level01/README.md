This mission can be found [here](https://www.hackthissite.org/missions/prog/1/) (Requires being logged into an account). An example of the question is given below.
